...
- Какие требования предъявляет к архитектуре PM/РП?
  - список работ
  - оценки трудозатрат и времени на реализацию
  - список ресурсов/компетенций, необходимых для реализации решения
 - Какие источники проектных рисков мы можем выделить?
  - сделаем не то, что требуется (неполнота требований)
  - сделаем не так (архитектурный синтез соответствие архитектуры требованиям)
  - противоречивость требований (трейдоффы)
- Как можно по архитектуре создать план проекта?
  - работы по снятию рисков (см. выше)
    -   
...
- Типовые PoV
  - диаграмма классов
    - связанность - тестопригодность (стоимость покрытия тестами), гибкость (стоимость внесения изменений)
    - интерфейсы - возможность подменить реализации
